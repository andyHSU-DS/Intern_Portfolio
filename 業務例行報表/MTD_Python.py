...
from time_range import last_month_range
...
def Final_OnShore_Offshore(Current_Open_Onshore_Account , Current_Open_Offshore_Account) : 
    ...
    Open_Account = pd.merge( onshore , offshore )
...
output_path = r'D:\My Documents\andyhs\桌面\Andy\業務例行報表\output\MTD_Monthly_Sales_Performance_Statistic_2022_03-17_Mar.xlsx'
